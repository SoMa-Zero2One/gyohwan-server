...
@Service("inuEmailTriggerService")
...
public class EmailTriggerService {
    ...
    public void triggerNewUserRegistrationEmail(String email, String uuid, String nickname, String collegeName) {
        try {
            ...
            log.info("인천대 이메일 트리거 요청 성공 - Email: {}, Nickname: {}", email, nickname);

        } catch (Exception e) {
            log.error("인천대 이메일 트리거 요청 실패 - Email: {}, Error: {}", email, e.getMessage());
